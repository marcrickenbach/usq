/** ****************************************************************************
 * @brief Pot instance configuration interface.
 */

#ifndef FKMG_POT_INSTANCE_CFG_H
#define FKMG_POT_INSTANCE_CFG_H
...
struct Pot_Instance_Cfg{
    ...
    /* Required: for queuing state machine events (Pot_SM_Evt). */
    struct{
     ...
     * callback is sent event with signal k_Pot_Sig_Instance_Initialized. NULL
     * skips callback. */
    Pot_Listener_Cb cb;
};
